...
function AdminDashboard() {
  ...
  const fetchCustomers = async () => {
    try {
      const res = await fetch("http://localhost:3000/api/bookings/customers");
      const data = await res.json();
      setCustomers(data);
    } catch (err) {
  ...
  const fetchDoorstepOrders = async () => {
    try {
      const res = await fetch("http://localhost:3000/api/bookings/doorstep");
      const data = await res.json();
  ...
  const updateStatus = async (id, status) => {
    try {
      const res = await fetch(`http://localhost:3000/api/bookings/status/${id}`, {
        method: "PUT",
  ...
  const handleAccept = async (id) => {
    try {
      const res = await fetch(`http://localhost:3000/api/bookings/accept/${id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
  ...
  const handleAddService = async () => {
    try {
      const res = await fetch("http://localhost:3000/api/services/add", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleEditService = async () => {
    try {
      const res = await fetch(`http://localhost:3000/api/services/edit/${editService.id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
  ...
  const handleDeleteService = async (id) => {
    if (window.confirm("Are you sure you want to delete this service?")) {
      try {
        const res = await fetch(`http://localhost:3000/api/services/delete/${id}`, {
          method: "DELETE",
        });
        if (res.ok) {
